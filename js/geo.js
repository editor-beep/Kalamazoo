...
//
// DOWNTOWN anchors sit inside their real grid blocks — spaced so the buildings
// have room (pulling them onto the exact intersections crammed them together).
// The grid transform, for reference (Burdick & Michigan = grid 5.5, 4.5):
//     x = (gx − 5.5) × 14     z = 10 + (gy − 4.5) × 18
// Grid streets (W→E): Oakland −56, Westnedge −42, Park −28, Rose −14, Burdick 0,
// Portage 20, Pitcher 24; (S→N): Vine −44, South −26, Lovell −8, Michigan 10,
// Kalamazoo 37, North 56. OFF-MAP anchors (mill, flats, superfund, tower, WMU,
// Gibson, Northwest) lie outside the surveyed downtown sheet and keep their spots.
...
export const PLACES = {
  ...
  hotel:        { x: 11.5, z: 18.4, real: 'Burdick House → Radisson Plaza, 100 W. Michigan (NE of Burdick & Michigan)' },
  theatre:      { x: 10, z: -10.5, real: 'State Theatre, 404 S. Burdick — east side of the Mall' },
  gazette:      { x: -8.2, z: -10.5, real: 'Kalamazoo Gazette, 401 S. Burdick — across the Mall from the State' },
  shakespeares: { x: 16, z: -7, real: "Shakespeare's, 241 E. Michigan — east of the Mall" },
  ...
  mission:      { x: -8.4, z: 34.25, real: 'Kalamazoo Gospel Mission, 448 N. Burdick (west side)' },
  ...
  park:         { x: -22, z: -6, real: 'Bronson Park, the Park↔Rose block west of the Mall' },
  library:      { x: -19.9, z: -36.5, real: 'Central Library, 315 S. Rose St (south, its own ground)' },
  clubsoda:     { x: -20.2, z: 16.6, real: 'Club Soda, 1 Main — the west Michigan edge' },
  planetclaire: { x: -20.2, z: 22.5, real: 'Planet Claire, a Mall-era alternative storefront' },

  // the Vine / south corridor
  fourthcoast:  { x: 3, z: -33, real: 'Fourth Coast Cafe, the Vine corridor south of South St' },
